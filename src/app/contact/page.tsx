      ...
      <section className={styles.layout}>
        ...
        <div className={styles.infoCol}>
          <div className={styles.infoCard}>
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <p className={styles.infoValue}>+233432654600</p>
              </div>
              </div>
              ...
              <div>
                ...
                <p className={styles.infoValue}>admin@cultureconnecttours.com</p>
              </div>
              </div>
              ...
              <div>
                ...
                <p className={styles.infoValue}>9th Floor Emporium Building,<br/>Mövenpick Ambassador Hotel</p>
              </div>
              </div>
            <div className={styles.infoItem}>
              <div className={styles.iconWrap}>
          ...
          <div className={styles.imageCard}>
            <div className={styles.imageLabel}>Accra, Ghana</div>
          </div>
        </div>
